...
education: "BCA, Sri Guru Tegh Bahadur Institute of Management and Information Technology (GGSIPU)"
focus:
  - "Python & SQL driven data analysis"
  - "NLP components for production web apps"
  - "Statistical modeling & predictive analytics"
  - "Turning raw datasets into decision-ready insights"
mindset: "Solutions-first, detail-oriented, product-aware"
```

I'm an analytical, solutions-driven Data Analyst building toward a career in Data Science. My background is in **cleaning and transforming raw datasets into actionable insights**, **building NLP components for production web applications**, and **using data visualization to guide strategic product decisions**. I care about the full path from messy data to a decision someone can actually act on.

**🎯 Open To:** Data Analyst / Junior Data Scientist roles · NLP & ML internships · Data-driven product collaborations
...
|:--|:--:|:--|
| **NLP / Text Mining** | Practitioner | Keyword extraction, TF-IDF, cosine similarity for text-matching pipelines |
| **Predictive Modeling** | Practitioner | Classification & regression with Scikit-Learn, train/test validation |
| **Feature Engineering** | Practitioner | Missing-value handling, categorical encoding, outlier treatment |
| **EDA & Statistics** | Practitioner | Exploratory analysis, A/B testing fundamentals, statistical reasoning |
| **Data Visualization / BI** | Practitioner | Power BI dashboards for executive-level reporting |
...
<details>
<summary><b>📊 Predictive Consumer Analytics Platform</b></summary>
<br/>

A predictive analytics pipeline that turns raw customer data into a forecast-ready model and an executive-facing dashboard.
...
<details>
<summary><b>📄 Resume Ranking & Job-Fit Scoring Tool</b></summary>
<br/>

An end-to-end tool that scores resumes against a target job description, extending a keyword-matching approach used in production.
...
### Intern Data Analyst — Superbresume.com
**Mar 2025 – Nov 2025**

Worked on the data and NLP pipeline behind a production resume platform, from raw data cleanup to user-behavior analysis.

- **Data Transformation:** Collected, cleaned, and processed large-scale unstructured resume datasets in Python, extracting structured entities (skills, categories, experience timelines)
- **NLP & Feature Development:** Collaborated on text-mining and keyword-matching models to suggest context-relevant skills based on job descriptions
- **Product Insights:** Ran exploratory analysis on user interaction data with Pandas, identifying conversion drop-off points to improve retention and product strategy
- **Database Querying:** Used SQL to build, update, and manage relational schemas for user profiles and industry skill tokens

`Python` `Pandas` `SQL` `NLP` `Text Mining` `Feature Engineering`
...
learning:
  ...
  - "Cloud platforms for data workflows"
building:
  - "NLP-driven data products"
  - "End-to-end ML pipelines with clean, production-style code"
exploring:
  - "MLOps basics"
  - "Applied A/B testing"
open_to:
  - "Data Analyst / Junior Data Scientist roles"
  - "NLP & ML collaborations"
```
